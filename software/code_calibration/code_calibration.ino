...
//else{
  ...
  scale.set_scale(2840.f); // valeur de calibration a définir
...
void loop() {
    ...
    RTC.setAlarm(ALM1_MATCH_MINUTES, 0, 0, 0, 0);   //creation alarme toutes les heures
   ...
   // Serial.print("fin veille");
    if(mode == 0){ // mode normal
      ...
      delay(500);
      float poids = scale.get_value(10) / 17000;
      ...
      float shthum = sht.GetRelHumidity();
